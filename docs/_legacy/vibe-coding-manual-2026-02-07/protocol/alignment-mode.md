...
**docs/project/VISION.md threshold failures:**
...
**docs/project/EPICS.md threshold failures:**
...
**docs/project/NEXT.md threshold failures:**
...
If docs/project/VISION.md, docs/project/EPICS.md, or docs/project/NEXT.md exist elsewhere in the repo (scattered or misplaced), use the Doc Discovery + Migration section below to locate and migrate into docs/project/. Do not invent new content to pass gates; discover and migrate existing planning docs first.
...
- Repo state verified (clean tree, tests pass, no conflicts with docs/project/NEXT.md)
...
- **Trigger:** Start-of-Session Doc Audit fails because `docs/project/VISION.md` and/or `docs/project/EPICS.md` and/or `docs/project/NEXT.md` are missing OR present-but-placeholders (TBD/TODO/empty).
...
- **docs/project/VISION.md:** purpose + user promise + non-goals (no TBD).
- **docs/project/EPICS.md:** at least 1 epic with an ID + short description + status.
- **docs/project/NEXT.md:** Active Story ID + NEXT STEP + DoD + scope guardrails + Done When checklist (no TBD).
...
### When to use (trigger)
- **Trigger:** Start-of-Session Doc Audit passes existence check (docs/project/VISION.md, docs/project/EPICS.md, docs/project/NEXT.md all exist) BUT Population Gate **FAIL** (placeholders detected or minimum content requirements not met).
...
1. **docs/project/VISION.md placeholders:**
...
2. **docs/project/EPICS.md placeholders:**
...
3. **docs/project/NEXT.md placeholders:**
...
5. **Update Last Updated date:** Set docs/project/NEXT.md "Last Updated:" to today (YYYY-MM-DD)

### Exit criteria (Population Gate PASS)
- docs/project/VISION.md: Purpose + North Star + User Promise + Non-Goals (all non-placeholder)
- docs/project/EPICS.md: At least 1 epic with ID + status + description (all non-placeholder)
- docs/project/NEXT.md: ACTIVE STORY ID + NEXT STEP + DoD + Scope + Done When (at least 3 items, NONE with placeholders) + Last Updated date (all non-placeholder)
