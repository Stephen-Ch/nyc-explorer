...
- Last Updated: Date (YYYY-MM-DD format) showing when docs/project/NEXT.md was last refreshed
- **Inputs/Research (when applicable):** Links to return packets in docs/status/ that informed this work (see [return-packet-gate.md](return-packet-gate.md))
...
**docs/project/NEXT.md Lightweight Rule:**
...
3. docs/project/VISION.md, docs/project/EPICS.md, docs/project/NEXT.md all exist with required content
...
If ANY required artifact is missing or docs/project/NEXT.md is unclear/outdated:
...
If ALL required artifacts are present and docs/project/NEXT.md is clear:
- Work state: READY
...
Any occurrence of these markers in Control Deck files (docs/project/VISION.md, docs/project/EPICS.md, docs/project/NEXT.md) is FAIL.
...
"NYC Explorer exists to help people explore Manhattan on foot with a map-first walking guide."
...
### docs/project/VISION.md must include:
...
"NYC Explorer exists to help people explore Manhattan on foot using a simple map-first experience. Users can browse curated POIs and short routes backed by a stable data contract and deterministic end-to-end tests."

**FAIL example (Purpose section):**
"A game about politics." (only 4 words, lacks explanation of problem solved)

### docs/project/EPICS.md must include:
...
### docs/project/NEXT.md must include:
...
1. Files exist? (docs/project/VISION.md, docs/project/EPICS.md, docs/project/NEXT.md)
