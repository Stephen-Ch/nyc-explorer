...
A **return packet** is a markdown research artifact stored in `docs/status/` with the naming convention:
...
- [ ] **Exists in docs/status/** with correct naming convention
...
| **GitHub.com Agent** | Researcher | Executes return-packet prompt; creates docs/status/ artifacts |
...
│    Uses template from:                                          │
│    docs/vibe-coding/templates/github-agent-return-packets-      │
│    prompt-template.md                                           │
└─────────────────────────────────────────────────────────────────┘
                              ▼
┌─────────────────────────────────────────────────────────────────┐
│ 3. GitHub.com Agent executes prompt                             │
│    Creates return packet(s) in docs/status/                     │
