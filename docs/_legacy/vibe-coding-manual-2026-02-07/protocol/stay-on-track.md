...
When changing shared patterns (palette CSS variables, UI copy, layout grids, shared JS helpers, adapters), you MUST verify coverage across the real NYC Explorer routes.

Mandatory route coverage list (match `apps/web-mvc/Program.cs` and controllers):
- /
- /poi/{id}
- /__view-home
- /__view-ok
