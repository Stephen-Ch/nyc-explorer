...
- Purpose: Control Deck placeholder scan (docs/project/* only) and NEXT freshness when PRs include non-docs changes.
- Copy these into the target repo:
   - docs/vibe-coding/tools/doc-audit.ps1
   - scripts/doc-audit.ps1
   - docs/vibe-coding.config.json
   - .github/workflows/doc-audit.yml
- Run locally: pwsh ./scripts/doc-audit.ps1
- CI behavior:
   - Placeholder scan is Control Deck only (docs/project/VISION.md, EPICS.md, NEXT.md)
...
Lines 90-107 use Rawls Game as docs/project/VISION.md example. Replace with generic examples or your project's actual purpose statement.
...
1. Verify existing VISION/EPICS/NEXT meet required-artifacts.md thresholds:
   - docs/project/VISION.md sections >= 25 words each
   - docs/project/EPICS.md descriptions >= 15 words with goals + success criteria
   - docs/project/NEXT.md NEXT STEP >= 10 words, DoD >= 10 words, Done When items >= 6 words
...
4. Update Control Deck if format changed (e.g., docs/project/NEXT.md gained "Done When" section in v7)
...
- [ ] Update docs/project/VISION.md examples (lines 90-107): replace Rawls Game examples with [your project purpose] or generic placeholders
...
- docs/project/VISION.md (product purpose, unique to each project)
- docs/project/EPICS.md (feature roadmap, unique to each project)
- docs/project/NEXT.md (current story, unique to each project)
