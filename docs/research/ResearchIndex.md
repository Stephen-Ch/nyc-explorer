...
| R-050 | POI promotion criteria for BBL landmark seeds (source hierarchy, verification checklist, reject/defer rules) | [docs/research/R-050-POI-Promotion-Criteria-for-BBL-Landmark-Seeds.md](R-050-POI-Promotion-Criteria-for-BBL-Landmark-Seeds.md) | Complete |
...
| R-053 | Manhattan-first research sources reference (tiered source map, query guidance, cheat sheet, specialty collections, staleness notes) | [docs/research/RESEARCH-SOURCES.md](RESEARCH-SOURCES.md) | Complete |
